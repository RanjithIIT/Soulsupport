...
# Remove the incorrectly placed _formatDateTime method (the one that's causing the error)
# It should be a method of the class, not inside the LayoutBuilder
...
print("Fixed _formatDateTime placement in events.dart")
