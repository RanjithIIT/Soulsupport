...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _navigateToLoginPage(BuildContext context, String role) {
    ...
    switch (role) {
      case 'management':
        page = const ManagementLoginPage();
        break;
      case 'teacher':
                  ...
                  child: Column(
                    children: [
                      ...
                      GridView.count(
                        ...
                        children: [
                          roleTile('admin', Icons.business_center_rounded, 'Admin', 'Full access'),
                          roleTile('management', Icons.apartment_rounded, 'Management', 'Control access'),
                          roleTile('teacher', Icons.school, 'Teacher', 'Academic access'),
                          roleTile('parent', Icons.family_restroom, 'Parent', 'Student access'),
                        ],
                      ),
                      ...
                      AnimatedContainer(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () => _navigateToLoginPage(context, selectedRole),
                          child: Text(
