...
class StudentData {
  ...
  StudentData.fromJson(Map<String, dynamic> studentJson, Map<String, dynamic> detailedJson)
      : name = _getFullName(studentJson),
        ...
        // Extracurricular
        extracurricularActivities = _safeString(studentJson['activities']),
        extracurricularLeadership = _safeString(studentJson['leadership']),
        extracurricularAchievements = _safeString(studentJson['achievements']),
        extracurricularParticipation = _safeString(studentJson['participation']),
