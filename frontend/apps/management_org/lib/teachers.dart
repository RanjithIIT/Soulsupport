...
class Teacher {
  ...
  factory Teacher.fromJson(Map<String, dynamic> json) {
    ...
    return Teacher(
      ...
      classTeacherSection: json['class_teacher_section'] as String?,
                                                  ...
                                                  lines: [
                                                    () {
                                                      if (teacher.isClassTeacher && 
                                                          (teacher.classTeacherClass != null || teacher.classTeacherSection != null)) {
                                                        return 'Class Teacher: ${teacher.classTeacherClass ?? ''} ${teacher.classTeacherSection ?? ''}'.trim();
