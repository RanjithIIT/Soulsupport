                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Γé╣${fee.totalAmount.toStringAsFixed(2)}',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Γé╣${fee.paidAmount.toStringAsFixed(2)}',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Γé╣${fee.dueAmount.toStringAsFixed(2)}',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
          ...
          if (updateResponse.success && updateResponse.data != null) {
            ...
            if (updatedFee != null) {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Fee updated successfully! New total: Γé╣${updatedTotal.toStringAsFixed(2)}'),
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (paymentAmount > fee.dueAmount && fee.dueAmount > 0) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Payment amount (Γé╣${paymentAmount.toStringAsFixed(2)}) cannot exceed due amount (Γé╣${fee.dueAmount.toStringAsFixed(2)})'),
              ...
              try {
                ...
                if (response.success) {
                  ...
                  if (response.data != null) {
                    ...
                    if (updatedFee != null) {
                      ...
                      if (updatedFee.paymentHistory.isNotEmpty) {
                        print('  - First payment: Γé╣${updatedFee.paymentHistory.first.paymentAmount} on ${updatedFee.paymentHistory.first.paymentDate}');
                      }
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Payment of Γé╣${paymentAmount.toStringAsFixed(2)} recorded successfully'),
                        backgroundColor: Colors.green,
                      ),
                    );
                  }
                                        ...
                                        setState(() {
                                          ...
                                          if (response.success) {
                                            ...
                                            if (mounted) {
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(
                                                  content: Text('Payment of Γé╣${paymentAmount.toStringAsFixed(2)} recorded successfully with receipt number: ${receiptController.text.trim()}. If you upload a receipt with the same receipt number, it will be automatically linked.'),
                                                  backgroundColor: Colors.green,
                                                  duration: const Duration(seconds: 4),
                                                ),
                                              );
        ...
        children: [
          Expanded(
            child: _StatCard(
              ...
              label: 'Total Fees',
              value: 'Γé╣${totalFees.toStringAsFixed(0)}',
          ...
          Expanded(
            child: _StatCard(
              ...
              label: 'Paid',
              value: 'Γé╣${totalPaid.toStringAsFixed(0)}',
          ...
          Expanded(
            child: _StatCard(
              ...
              label: 'Pending',
              value: 'Γé╣${totalPending.toStringAsFixed(0)}',
...
class _StatsOverview extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final formatter = NumberFormat.currency(symbol: 'Γé╣', decimalDigits: 0);
    return Padding(
...
class _SummaryBoxesSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final formatter = NumberFormat.currency(symbol: 'Γé╣', decimalDigits: 2);
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  // Show summary in header: Total: Γé╣X Paid: Γé╣Y Due: Γé╣Z (with proper spacing and clear headings)
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Text(
                        'Total: Γé╣${totalAmount.toStringAsFixed(2)}',
                        style: const TextStyle(
                          fontSize: 13,
                          color: Colors.black87,
                          fontWeight: FontWeight.w500,
                      ...
                      const SizedBox(width: 20),
                      Text(
                        'Paid: Γé╣${paidAmount.toStringAsFixed(2)}',
                        style: TextStyle(
                          fontSize: 13,
                      ...
                      const SizedBox(width: 20),
                      Text(
                        'Due: Γé╣${dueAmount.toStringAsFixed(2)}',
                        style: TextStyle(
                          fontSize: 13,
              ...
              builder: (context) {
                ...
                return Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _FeeDetailRow(label: 'Total:', value: 'Γé╣${totalAmount.toStringAsFixed(2)}'),
                      _FeeDetailRow(label: 'Paid:', value: 'Γé╣${paidAmount.toStringAsFixed(2)}'),
                      _FeeDetailRow(
                        label: 'Due:',
                        value: 'Γé╣${dueAmount.toStringAsFixed(2)}',
          ...
          child: Table(
            ...
            children: [
              ...
              ...paymentHistory.map((payment) {
                ...
                final amount = 'Γé╣${parseAmount(payment['payment_amount']).toStringAsFixed(2)}';
